...
<?php echo form_open("Petstore_Controller/servicevalidation"); ?>

    <form name='service' method="POST" >
        <table>
             <tr>
                <td> <label class="lab">* First Name:</label></td>
                <td><input type="text" name="fn" size="31" cols="30" ></td>
             </tr>
             <tr>
                <td><label class="lab">* Last Name:</label></td>
                <td><input type="text" name="ln" size="31" cols="30"></td>
             </tr>
             <tr>
                <td><label class="lab">* E-mail:</label></td>
                <td><input type="email" name="email" size="31" cols="30"></td>
             </tr>
             <tr>
                <td><label class="lab">Phone:</label></td>
                <td><input type="tel" name="phone" size="31" cols="30"></td>
             </tr>
             <tr>
                 <td><label class="lab"> Business Name:</label></td>
                 <td> <input type="text" name="businessname" size="31" cols="30"></td>
             </tr>
            <tr>
